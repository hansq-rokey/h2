	...
	<body>
		...
		<div class="article">
			...
			<div class="right " unselectable="on" style="-moz-user-select:none;" onselectstart="return false;">
				...
				<!-- B端不可见的商品规格 -->
				<c:forEach items="${noneFormats }" var="format" varStatus="status">
		...
		<div class="buy">
			...
			<div class="addbuy" style="margin-top: 10px;">
				<div class="add_Agreement">
				  <span class="buyprice"></span>
				  <a href="javascript:void(0)" class="buycar">加入购物车</a>
				  <p style="display:none">点击立即购买表示您知晓并同时意<a href="#">熊爸爸发热墙纸下单协议</a></p>
				</div>  	
