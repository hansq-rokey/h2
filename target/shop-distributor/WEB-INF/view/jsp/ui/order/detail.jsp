...
<body>
							...
							<div class="order-sp">
								...
								<div class="sp-right">
									...
									<div class='logistics-info'>
										<div class="detail detail_on" style="position:relative;display:inline-block;"><a  href="javascript:void(0)" style="color: #ff6200;">物流信息</a>
							...
							<div class="order-info clearfix">
								<div class="order-info-money fl">
									...
									<p><em>定金支付</em>：<span  class="priceSpan">-<fmt:formatNumber value="${order.frontMoney }" type="currency" maxFractionDigits="2" minFractionDigits="2" /></span></p>
 									<p><em>优惠券</em>：<span  class="priceSpan">-<fmt:formatNumber value="${order.enableCouponMoney }" type="currency" maxFractionDigits="2" minFractionDigits="2" /></span></p>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$('.detail_on').mouseenter(function(event){
				$('.logistics-box').show();
				event.stopPropagation();
			});
			$('.detail_on').mouseleave(function(event){
				$('.logistics-box').hide();
			}); *///德邦物流
