                    ...
                    <div class="info-right">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><fmt:formatNumber value="${carItem.carItem.unitPrice}" type="currency" maxFractionDigits="2" minFractionDigits="2" /></td>
...
<%--                             <c:if test="${carItem.invitationCodes!=null and fn:length(carItem.invitationCodes)>0 }">
                ...
                <c:if test="${fn:length(bomList)>0 }">
	                <div class="info info-address clearfix">
	                <h6>物料信息</h6>
		                <div class="info-right" style="width:90%">
                ...
                <div class="info-money">
                    ...
                    <p class="score"><label><input type="checkbox" data-value="${couponPrice}" value="order." />使用优惠券</label><span style="display:none">-<fmt:formatNumber value="${couponPrice}" type="currency" maxFractionDigits="2" minFractionDigits="2" /></span></p>
