...
public interface MallOrderService {
     ...
     * @return
     */
    MallOrder commit(MallOrderModel order,User user,Long addressId,String deliverTimeName,String deliverValue,String ip,List<MallCarItem> mallList,Float fixateProfit,Float couponMoney);
     ...
     * @return
     */
    MallOrder createSingleOrder(User user,MallBasicCategoryModelFormat format,OrderSubmitInfo info,String ip,List<MallFormatExt> extList,Float totalPrice,String depositIds,Float length,Float width,Float hight,Float groundArea,Float fixateProfit,Float couponMoney);
