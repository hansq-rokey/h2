...
//		orderUpdateStatus.setStatus(OrderStatusEnum.AFTERSALE.getCode());
//		orderUpdateStatus.setId(order.getId());
//		orderService.updateOrder(OrderStatus.AFTERSALE.getStatus(), order.getOrderNumber());TODO
//		orderDao.updateByPrimaryKeySelective(orderUpdateStatus);
		//添加订单历史记录
