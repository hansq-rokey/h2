...
class UAliPayController extends AbstractController {
	...
	String pay(ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String notify_url = "http://daili.ibaixiong.com/pay/notify/ali/pc.html";
		// String return_url =
		// "http://商户网关地址/create_direct_pay_by_user-JAVA-UTF-8/return_url.jsp";
		String return_url = "http://daili.ibaixiong.com/u/ali/payafter.html";
		// 付款金额
		...
		String subject = "";
		String body = "";
		String show_url = "http://daili.ibaixiong.com/u/order/detail.html?number=" + out_trade_no;
	...
	String depositPay(ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// String return_url =
		// "http://商户网关地址/create_direct_pay_by_user-JAVA-UTF-8/return_url.jsp";
		String return_url = "http://daili.ibaixiong.com/u/ali/deposit/payafter.html";
		// 付款金额
		String total_fee = order.getFrontMoney().toString();

		// 订单名称查询订单详情中的商品名称
		String show_url = "http://daili.ibaixiong.com/u/deposit/detail.html?number=" + out_trade_no;
