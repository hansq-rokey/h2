...
import com.ibaixiong.mall.service.MerchantBondMoneyRecordService;
import com.ibaixiong.mall.service.MerchantCouponMoneyRecordService;
import com.ibaixiong.mall.service.MerchantFirstGoodsRecordService;
import com.ibaixiong.mall.service.MerchantRebateMoneyRecordService;
import com.ibaixiong.mall.service.MerchantSaleMoneyRecordService;
...
class AbstractController {
	...
	@Resource
	protected MerchantBondMoneyRecordService bondRecordService;
	
	@Resource
	protected MerchantCouponMoneyRecordService couponRecordService;
	
	@Resource
	protected MerchantFirstGoodsRecordService firstGoodsRecordService;
	@Resource
	protected MerchantSaleMoneyRecordService saleRecordService;
	@Resource
	protected MerchantRebateMoneyRecordService rebateRecordService;
	...
	public Float getMerchantProfit(HttpServletRequest request){
		SsssCityMerchant merchant=(SsssCityMerchant) request.getSession().getAttribute("merchant");
		if(merchant!=null){
			return merchant.getFixateProfit();
		}
		return 1f;
	}
	/**
