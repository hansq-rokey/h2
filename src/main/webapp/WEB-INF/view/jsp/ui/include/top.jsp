...
<div class="head clearfix">
	<div class="logo"><a href="###"><img src="http://fe.ibaixiong.com/common/image/logo02.png" class="indexlogo" /></a></div>
	...
	<ul class="login clearfix">
		...
		<li id="infoLi" style="display: none;"><a href="/u/order/list.html" id="userInfo">个人中心<img src="http://fe.ibaixiong.com/shop/images/jiantou.png" style="margin-left:5px;"></a>
				...
				<div class="person">
					...
					<p id="merchantLi" style="display: none;"><a href="http://merchant.ibaixiong.com" target="_blank">代理商</a></p>
					<p style="border-bottom:none;"><a href="/logout.html">退出</a></p>
				</div>
		</li>
	</ul>
	<ul class="menus clearfix">
	    <li><a href="http://merchant.ibaixiong.com">代理商</a> </li>
