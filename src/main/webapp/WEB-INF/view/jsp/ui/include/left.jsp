...
<ul>
	...
	<li id="codeli" style="display:none"><a href="/u/deposit/list.html">定金</a></li>
</ul>
<h3 style="display:none">售后服务</h3>
<ul>
	<li id="thli" style="display:none"><a href="/u/service/list/back.html">退货单</a></li>
	<li id="hhli" style="display:none"><a href="/u/service/list/exchange.html">换货单</a></li>
