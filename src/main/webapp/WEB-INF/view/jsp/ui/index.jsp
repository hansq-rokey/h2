...
<body>
	<!-- <div class="header">
		...
		<ul class="nav">
			<li><a href="/" class="header_on">首页</a></li>
		...
		<div class="header-right">
		  <a href="http://login.ibaixiong.com/login?service=http://www.ibaixiong.com/sso">登录</a>
		  <div id="userInfo" style="display: block;"><a href="/u/order/list.html">个人中心<img src="http://fe.ibaixiong.com/shop/images/jiantou.png" style="margin-left:5px;"></a>
    ...
    <div class="navbox">
        ...
        <ul class="headnav">
            ...
            <li id="loginInfo">
            	<a href="http://login.ibaixiong.com/login?service=http://daili.ibaixiong.com/sso" class="loginlink">登录/注册</a>
            </li>      
    ...
    <div class="slider-wrap">
        <div class="slider slider1 curslider">
            ...
            <div class="button-wrapper">
            	<p class="button-wrapper" style="margin-top:300px;font-size:16px;"><span class="paper-price" style="margin-left:566px;color:#fff;"><span class="strong">568</span>元/㎡</span> </p>
        ...
        <div class="slider slider2">
            ...
            <div class="button-wrapper">
                 <!--<div class="linkdiv seediv-bath"> <a href="/u/product/52.html" class="seedetails-bath">立即购买</a><span class="seedetailsspan-bath"></span></div>-->
		...
		<div class="content-box">
          ...
          <div class="row index_margin1">
	          	<div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 index_text ">
	                  ...
	                  <a href="http://bbs.ibaixiong.com/detail/435.html" target="_blank">
	                  	 <img src="http://fe.ibaixiong.com/shop/images/20160813_1.jpg" class="index_img ">
	                  </a>
                    <span class="index_title2">石墨烯产业技术技术战略联盟秘书长李义春来访</span>
	                </div>
	          	</div>
	          	<div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 index_text ">
	          		<div class="index_img_box index_text1">
	          		<a href="http://bbs.ibaixiong.com/detail/488.html" target="_blank">
	                	<img src="http://fe.ibaixiong.com/shop/images/20160902084950466.jpg" class="index_img">
	                </a>
                      <span class="index_title2">“国际石墨烯创新创业大赛”熊爸爸尽显风采</span>
	                </div>
	          	</div>
	          	<div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 index_text ">
	          		<div class="index_img_box index_text1">
          ...
          <div class="row index_margin1">
          	...
          	<div class="col-lg-4 col-lg-4 col-md-4 col-sm-4 index_text_left">
              	...
              	<li id="first"><a href="###"><span>央视《对话》石墨烯应用的未来</span><i class="index_time">8.10</i></a></li>
