...
<html>
	<head>
    	...
    	<script src="/js/data_tool_v2.js"></script>
	</head>
	<body>
			...
			<div class="right " unselectable="on" style="-moz-user-select:none;" onselectstart="return false;">
				...
				<div class="delimiter" id="delimiter">
					...
					<div class="delimiter_conetent">
						 <div class="delimiter_list"> <label>房屋面积：</label><input id="delim_arae" class="delim_arae" name="num" type="text" onchange="keyup(this.value,$(this))"></div>
						 <div class="delimiter_list"> <label>房屋总长：</label><input id="paper_arae" class="paper_arae" name="num" type="text" onchange="keyup(this.value,$(this))"></div>
						 <div class="delimiter_list"> <label>高：</label><input id="paper_h" class="paper_arae" name="num" type="text" onchange="keyup(this.value,$(this))"></div>
					</div>
				</div>
			</div>
			<div class="down">
