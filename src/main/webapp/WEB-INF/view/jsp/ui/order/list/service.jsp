...
<head>
    ...
    <link href="http://fe.ibaixiong.com/shop/css/sale-service.css" rel="stylesheet" type="text/css">
    ...
    <div class="content">
        ...
        <div class="clearfix">
            ...
            <div class="content-right">
                ...
                <form action="/u/service/commit.html" method="post" onsubmit="return checkEmpty();">
                       		...
                       		<tr>
                                ...
                                <td>
									<div class="change">
										...
										<input type="text" name="items[${statusItem.index}].num" data-txt="number" data-max="${orderItem.orderItem.num }" class="number" value="1"/>
